...
function param_action(dialog, param_index)
  ...
  elseif (param_index == 1) then
    ...
    print("PARAM"..param_index.." = "..(param and param.value or "nil"))
  end
  return 1
end
...
iup.Destroy(pack)
--iup.SetLanguageString("IUP_CANCEL", "取消")
--iup.SetLanguageString("IUP_OK", "确定")
...
ret, pboolean, pinteger, preal, pinteger2, preal2, pangle, pstring, plist, pstring2 = 
      iup.GetParam("_@IUP_TEST", param_action,
                  "Boolean: %b\n"..
                  "Integer: %i\n"..
                  "Real 1: %r\n"..
                  "Sep1 %t\n"..
